...
interface UseGuestCheckoutOptions {
  onSuccess: (data: ContactFormData) => void;
}

/**
 * Hook para gestionar el checkout como invitado
 * Maneja validación de email, autenticación como invitado y estados de procesamiento
 */
export function useGuestCheckout({ onSuccess }: UseGuestCheckoutOptions) {

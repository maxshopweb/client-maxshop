...
interface ButtonProps extends ButtonHTMLAttributes<HTMLButtonElement> {
    variant?: "primary" | "secondary" | "success" | "cancel" | "outline-primary" | "outline-secondary" | "outline-success" | "outline-cancel" | "ghost";
...
export function Button({
    ...
    const baseStyles = "px-4 py-2 sm:px-5 sm:py-2.5 text-sm sm:text-base rounded-full font-medium transition-all duration-300 active:scale-95 disabled:opacity-40 disabled:cursor-not-allowed disabled:active:scale-100 disabled:hover:scale-100 disabled:hover:shadow-none relative overflow-hidden group min-w-[150px]";

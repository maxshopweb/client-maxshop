...
export default function ProfileHeader({ user }: ProfileHeaderProps) {
  ...
  return (
    <div className="bg-card rounded-xl shadow-sm border border-input p-4 sm:p-6">
      {/* Avatar y Nombre */}
      <div className="flex flex-col items-center text-center mb-6 pb-6 border-b border-input/50">
        ...
        <h2 className="text-xl sm:text-2xl font-semibold text-foreground/90 mb-1">
